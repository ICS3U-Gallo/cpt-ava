...
# game screen
    ...
    if current_screen == "game":
        ...
        arcade.draw_xywh_rectangle_filled(menubutton[0], menubutton[1], menubutton[2], menubutton[3], arcade.color.BLACK)
...
# instructions screen
    ...
    if current_screen == "instructions":
        ...
        arcade.draw_text("1. Use the arrow keys to move the player fish up, down, left and right", WIDTH / 2 - 300,
                         HEIGHT - 100, arcade.color.BLACK, 13)
        arcade.draw_text("2. Eat fish of smaller or equivalent size and increase in size", WIDTH / 2 - 300,
                         HEIGHT - 130, arcade.color.BLACK, 13)
        arcade.draw_text("3.    If you try to eat fish larger than the player fish, GAME OVER.", WIDTH / 2 - 300,
                         HEIGHT - 160, arcade.color.BLACK, 13)
        arcade.draw_text("4. The goal is to be the largest fish in the ocean.", WIDTH / 2 - 300, HEIGHT - 190,
...
def on_mouse_press(x, y, button, modifiers):
    ...
    if x > menubutton[0] and x < menubutton[0] + menubutton[2] and y > menubutton[1] and y < menubutton[1] + menubutton[3]:
        current_screen = "menu"
...
# pythagereon therom to find distance from player and big enemy fish, only append if far enough
...
# collision of player fish and enemy fish; game over with big fish, eat small fish
